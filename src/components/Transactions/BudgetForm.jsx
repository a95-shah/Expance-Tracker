...
const BudgetForm = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      console.log("Attempting to save budget for:", user.uid);
      ...
      toast.error("Failed to save budget. Check console for details.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input 
              ...
              required
            />
            <p className="text-xs text-gray-500 mt-1">Exact name as used in transactions</p>
          </div>
          <div>
